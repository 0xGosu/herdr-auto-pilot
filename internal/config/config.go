...
type Escalations struct {
	...
	FullAuto   FullAuto   `toml:"full_auto"`
}

// FullAuto configures full-auto prompting mode: when enabled, every pending
...
// the runtime preconditions hold: at least MinFullAutoGraduatedRules
...
// MinFullAutoGraduatedRules is how many graduated (autonomous) rules the
// database must hold before full-auto mode may be enabled. A constant, not a
...
const MinFullAutoGraduatedRules = 10
